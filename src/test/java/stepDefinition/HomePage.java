...
public class HomePage {
	...
	public void user_see_title_of_the_page_as_home() {
	
	}

	@Then("User see a logo image with the company name on the Home Page")
	public void user_see_a_logo_image_with_the_company_name_on_the_home_page() {
	  
	}

	@Then("User see a tab with text PRODUCT on the top menu bar of the Home page")
	public void user_see_a_tab_with_text_product_on_the_top_menu_bar_of_the_home_page() {
	    
	}

	@Then("User see a tab with text Clients on the top menu bar of the Home page")
	public void user_see_a_tab_with_text_clients_on_the_top_menu_bar_of_the_home_page() {
	   
	}

	@Then("User see a tab with text Team on the top menu bar of the Home page")
	public void user_see_a_tab_with_text_team_on_the_top_menu_bar_of_the_home_page() {
	   
	}

	@Then("User see a tab with text Register on the top menu bar of the Home page")
	public void user_see_a_tab_with_text_register_on_the_top_menu_bar_of_the_home_page() {
	    
	}

	@Then("User see a tab with text About on the bottom menu bar of the Home page")
	public void user_see_a_tab_with_text_about_on_the_bottom_menu_bar_of_the_home_page() {
	    
	}

	@Then("User see a tab with text Featured on the bottom menu bar of the Home page")
	public void user_see_a_tab_with_text_featured_on_the_bottom_menu_bar_of_the_home_page() {
	    
	}

	@Then("User see a tab with text Contact Us on the bottom menu bar of the Home page")
	public void user_see_a_tab_with_text_contact_us_on_the_bottom_menu_bar_of_the_home_page() {
	   
	}

	@Then("User see a search option symbol on the bottom menu bar of the Home page")
	public void user_see_a_search_option_symbol_on_the_bottom_menu_bar_of_the_home_page() {
	    
	}

	@Then("User see a Signin option next to the search button on the bottom menu bar of the Home page")
	public void user_see_a_signin_option_next_to_the_search_button_on_the_bottom_menu_bar_of_the_home_page() {
	...
	public void user_is_re_directed_to_doctor_team_page() {
	...
	public void user_should_see_three_default_doctor_names_on_first_page() {
